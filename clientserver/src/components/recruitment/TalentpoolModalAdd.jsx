...
export default function TalentpoolModalAdd({ data, close, show, sending_error }) {
    ...
    const handleAdd = () => {
        ...
        axios
            .post('/api/recruitment/talentpool/add', {
                ...ticket,
                talentpool: data,
    ...
    return (
        <Modal show={show} onHide={handleClose}>
            <Modal.Header closeButton>
                ...
                {responseCode === undefined && isGoogleSetup !== false ? (
            ...
            {isGoogleSetup ? (
                spin ? (
                    ...
                    <Modal.Body>
                        <Google callback={handleAdd} googleMessage={googleMessage} modal={true} />
                    </Modal.Body>
                )
            ) : (
                <Modal.Body>
