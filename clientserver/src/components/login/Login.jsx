	...
	return (
		<div className="container login-form" style={{ maxWidth: '500px' }}>
			<form onSubmit={handleSubmit(onSubmit)}>
				<h1>Login</h1>
				<Alert alert={alert} />
				<Input text="Email" err={errors} handle={register} name="email" value={input.email} type="email" placeholder="Enter your Email" />
				<Input text="Password" err={errors} handle={register} name="password" value={input.password} type="password" placeholder="Enter your Password" />
